...
const About = () => {
  return (
    <div className={styles.container}>
      ...
      <div id={styles.para1}>
        I am a software developer based in Kochi, India and my areas of
        expertise include web development, Linux system administration and
        configuring SOHO network infrastructure.
      </div>
      <div id={styles.para2}>
